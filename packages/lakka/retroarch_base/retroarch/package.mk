...
makeinstall_target() {
  ...
  install -m 0755 ${PKG_DIR}/config/wait_for_system_ready.sh ${INSTALL}/usr/share/retroarch/wait_for_system_ready.sh
...
post_install() {
  ...
  enable_service require_system_ready.service
