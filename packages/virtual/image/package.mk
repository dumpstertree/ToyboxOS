...
PKG_DEPENDS_TARGET="toolchain squashfs-tools:host dosfstools:host fakeroot:host kmod:host mtools:host populatefs:host libc gcc linux linux-drivers linux-firmware ${BOOTLOADER} busybox util-linux corefonts misc-packages debug exfatprogs"
PKG_SECTION="virtual"
...
[ "${PROJECT}" = "Generic" -a "${ARCH}" = "x86_64" ] && [ "${SKIP_VIRTUAL_APPLIANCE}" != "yes" ] && PKG_DEPENDS_TARGET+=" virtual"
